...
function BoardContent({
  ...
  // Ưu tiên sử dụng kết hợp 2 loại sensors là mouse và touch để có trải nghiệm trên moblie tốt nhất, không bị bug.
  ...
  const findColumnByCardId = (cardId) => {
    // Đoạn này cần lưu ý, nên dùng c.cards thay vì c.cardOderIds bởi vì ở bước handleDragOver chúng ta sẽ làm dữ liệu cho cards hoàn chỉnh trước rồi mới tạo ra cardOrderIds mới
  ...
  const moveCardBetweenDifferentColumns = (
    ...
    setOrderedColumns(prevColumns => {
      ...
      if (triggerFrom === 'handleDragEnd') {
        /**
         * Gọi lên props function moveCardToDifferentColumn nằm ở component cha nào cao nhất (boards/_id.jsx)
         ...
         * Thì lúc này chúng ta có thể gọi luôn API ở đây là xong thay vì phải lần lượt ngược lên những component cha phía bên trên. (Đối với component con nằm càng sâu thì càng khổ :D)
  ...
  // Trigger khi kết thúc hành động kéo (drag) một phần tử => thành động thả (drop)
  const handleDragEnd = (event) => {
    ...
    // Xử lý kéo thả Columns trong một cái boardConent
  ...
  const collisionDetectionStrategy = useCallback((args) => {
    ...
    // Tìm các điểm giao nhau, va chạm sẽ trả về một mảng các va chạm - intersections với con trỏ
