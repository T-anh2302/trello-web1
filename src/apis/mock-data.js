...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'TrungQuanDev MERN Stack Board 123',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://vcdn-giaitri.vnecdn.net/2022/12/25/avatar-3-jpeg-5860-1671963099.jpg',
      ...
      },
      {
         ...
         * Phía FE sẽ tự tạp ra một cái card đặc biệt: Placeholder Card, không liên quan tới BE
         ...
         * "columnId-placeholder-card" (mỗi column chỉ có thể có tối đa một cái PlaceholderCard)
